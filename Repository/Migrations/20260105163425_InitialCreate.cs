        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LaundryManId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "8e445865-a24d-4543-a6c6-9443d048cdb9", 0, "055e01c1-d3d2-4dc2-9465-8252ef3d2411", new DateTime(2026, 1, 5, 16, 34, 25, 578, DateTimeKind.Utc).AddTicks(9225), "admin@yudorm.com", true, "Sistem", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Yöneticisi", false, null, "ADMIN@YUDORM.COM", "ADMIN", "AQAAAAIAAYagAAAAELXYksRIxH6s38II4W03ieQqoRxJ0CuSuO51CURa5n3eosXjCso62Yfv2edfliY5YQ==", null, false, "dd12c5a3-0f44-41e3-ab63-c37918e20e44", false, "admin", "Admin" },
                    { "9dcfe6a4-9f6d-42ad-9a9a-d85423c08468", 0, "39a24e89-d283-49bf-a177-e04719bcd1e2", new DateTime(2026, 1, 5, 16, 34, 25, 614, DateTimeKind.Utc).AddTicks(9381), "laundryman@yudorm.com", true, "Laundry", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Service", false, null, "LAUNDRYMAN@YUDORM.COM", "LAUNDRYMAN", "AQAAAAIAAYagAAAAEAQF8MzmY1DU+sKmxnhu2n1eloL9fZRtGebU9BaaxiuAe8A15m8wg0Xf6v9QuvoFdw==", null, false, "a0aaea5b-96ee-4449-bc1a-2bbbf12c8ecf", false, "LaundryMan", "LaundryMan" }
                });
